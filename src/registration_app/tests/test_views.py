...
class TestCreateSchoolTeamView(TestCase):
    def setUp(self):
        ...
        self.form_data1 = {
            ...
            "guardian_mobile_phone": "+48576134323",
        ...
        self.form_data2 = {
            ...
            "post_code": "10-200",
            "street": "Wiejska 20",
            "school_mobile_phone": "+1111111111111111",
            "school_email": "jndfjkbhjbehjvbsdhj",
            "guardian_name": "Karol",
            "guardian_surname": "Siatka",
            "guardian_mobile_phone": "bdfvbdbfvndf",
            "guardian_email": "1128921fjsbdj",
            "member_name": "Steve",
            "member_surname": "Jobs",
        }
    ...
    def test_correct_data_saving(self):
        response = self.client.post(path=self.url, data=self.form_data1)
    ...
    def test_incorrect_data_saving(self):
        response = self.client.post(path=self.url, data=self.form_data2)
        print(response.json())
        self.assertEquals(response.json()["status"], 200)
